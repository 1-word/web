			...
			return (
					<div className="word_card" id={data?.word_id}>
						<div className="word_card_top">
							...
							<span className="word_card_read">{data?.wread ?? "" !== "" ? "["+data?.wread+"]" : ""}</span>
						...
						<div className="word_card_mean_wrap">
							<div className="word_card_mean_list">{data?.mean}1</div>
							<div className="word_card_mean_list">{data?.mean}2</div>
							<div className="word_card_mean_list">{data?.mean}3</div>
						</div>
						{/* 품사 영역 */}
